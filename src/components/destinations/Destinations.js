  ...
  return (
    <div name='destinations' className='destinations'>
      <div className='container'>
        ...
        <p>Bali, Bora Bora, Cancún, Los Roques, Maldives, Martinique, Oahu, et beaucoup plus de destinations partout dans le monde!</p>
        <div className='img-container'>
          <img className='span-3 image-grid-row-2' src={Maldives} alt="Une plage des Maldives" />
