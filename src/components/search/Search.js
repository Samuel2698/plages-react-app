    ...
    <div name='préparation' className='search'>
        <div className='container'>
            <div className='left'>
                ...
                <p>Venez découvrir le summum des vacances tout compris de luxe dans les meilleures plages du monde, y compris bien sûr pour les couples.Nos stations balnéaires de luxe, situées le long des plus beaux décors tropicaux et des plages exquises de Bali, de la Martinique, des Maldives, de Tahiti, de Cancún, etc. proposent des repas gastronomiques illimités, des bars uniques servant des liqueurs et des vins de qualité supérieure, de vues paradisiaques et une expérience incomparable! Si vous planifiez un mariage, nous sommes aussi le leader des mariages et des forfaits lune de miel.</p>
                <div className='search-col-2'>
                    <div className='box'>
                        <div>
                            <img src={Gold} alt="emblème 'WORLD TRAVEL AWARDS WINNER 2021'" style={{marginRight: '1rem'}}/>
                        </div>
                        <div>
